...
dataset = pd.read_csv('data/churn_data.csv')  # Users who were 60 days enrolled, churn in the next 30
...
print(dataset.describe())  # Distribution of Numerical Variables
